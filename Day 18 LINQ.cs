...
namespace Day18LINQ
{
    public class Day18LINQ
    {
        ...
        public static void Run()
        {
            ...
            {
                new Employee { EmpId = 1001, Name = "Elijah",   DeptId = 1, Salary = 48000, IsActive = true  },
                new Employee { EmpId = 1002, Name = "Klaus",  DeptId = 2, Salary = 62000, IsActive = true  },
                new Employee { EmpId = 1003, Name = "Kol", DeptId = 1, Salary = 55000, IsActive = true  },
                new Employee { EmpId = 1004, Name = "Finn",   DeptId = 3, Salary = 0,     IsActive = false }, // salary missing/0
                new Employee { EmpId = 1005, Name = "Marcel",  DeptId = 2, Salary = 38000, IsActive = true  },
                new Employee { EmpId = 1006, Name = "Rebekah",  DeptId = 1, Salary = 32000, IsActive = true  },
            };
            ...
            // GroupBy (group employees by DeptId)
            // Business idea:
            ...
            // Generics + LINQ together: FindFirstOrNull<Employee>
            // Business idea:
            ...
            // Dictionary<TKey,TValue> using LINQ counts
            // Business idea:
